...
export const updateProfile = createAsyncThunk("auth/updateProfile", async (payload, { getState }) =>
...
export const changePassword = createAsyncThunk("auth/changePassword", async (payload, { getState }) =>
  apiRequest("/api/profile/password", {
    method: "PATCH",
    token: getState().auth.accessToken,
    body: JSON.stringify(payload),
  })
...
const authSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(updateProfile.fulfilled, saveAuth)
      .addCase(signup.rejected, saveError)
      .addCase(login.rejected, saveError)
      .addCase(updateProfile.rejected, saveError)
      .addCase(changePassword.rejected, saveError);
  },
});
